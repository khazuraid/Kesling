        ...
        <div className="flex-1 overflow-y-auto p-6 md:p-8 bg-[hsl(var(--background))]">
          {module.parameters.length === 0 ? (
            <div className="text-center py-12 border border-dashed border-[hsl(var(--border))] bg-[hsl(var(--muted))]/10">
              <p className="text-[14px] text-[hsl(var(--muted-foreground))] font-medium">
                Modul ini belum memiliki parameter/field.
              </p>
            </div>
          ) : module.isRowBased ? (
              ...
              <table className="w-full text-left border-collapse">
                  ...
                  <tr className="bg-[hsl(var(--muted))]/30">
                    ...
                    {module.parameters
                      ...
                      .map((p: any) => (
                        <th
                          key={p.id}
                          className="p-4 border-b border-[hsl(var(--border))] text-[11px] font-bold text-[hsl(var(--muted-foreground))] uppercase tracking-wider min-w-[150px]"
                        >
                ...
                <tbody>
                  {!module.subCategories || module.subCategories.length === 0 ? (
                    <tr>
                      <td
                        colSpan={module.parameters.length + 1}
                        className="p-8 text-center text-[13px] text-[hsl(var(--muted-foreground))] font-medium"
                      >
